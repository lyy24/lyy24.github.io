$(document).ready(function () {
    ...
    var play_pause = $('.video__playButton'), container = $('#videoContainer'), playIcon = $('.video__playButton .video__playPause'), video = $('video'), play = $('.play'), volume = $('.video__volume .video__icon'), volumeIntesity = $('.video__volume .video__intensityBar'), intensity = $('.video__intensity'), progressBar = $('.video__progressBar'), progress = $('.video__progressBar .video__progress'), timer = $('.video__intialTime'), vidDuration = $('.video__fullTime'), expandButton = $('.video__scale .video__icons'), overlayScreen = $('.video__overlay'), timeState = $('.video__time'), overlayButton = $('.video__overlay .video__button'), update;
    ...
    function getTimeState() {
        ...
        var mouseX = Event.pageX - progressBar.offset().left, width = progressBar.outerWidth();
    ...
    function changeVolume() {
        var mouseX = Event.pageX - volumeIntesity.offset().left, width = volumeIntesity.outerWidth();
